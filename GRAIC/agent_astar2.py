...
def read_a_star_file(file_path):
...
class Agent():
    ...
    def pure_pursuit_lateral_controller(self, curr_x, curr_y, curr_yaw, waypoints):
        ...
        for waypoint in waypoints:
            ...
            print((curr_x, curr_y),waypoint,dist)
    ...
    def run_step(self, filtered_obstacles, waypoints, vel, transform, boundary):
        ...
        waypt = read_a_star_file(file_path)
        # Calculate the steering angle
        target_velocity = self.longitudinal_controller(curr_x, curr_y, current_velocity, curr_yaw, waypt)
        steer = self.pure_pursuit_lateral_controller(curr_x, curr_y, curr_yaw, waypt)
