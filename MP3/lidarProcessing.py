...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        filter_front_left = np.logical_and((x_points >= self.fwd_range[0]), (x_points >= 0))
        ...
        filter_front_right = np.logical_and((x_points >= self.fwd_range[0]), (x_points >= 0))
        ...
        filter_rear_left = np.logical_and((x_points >= self.fwd_range[0]), (x_points <= 0))
        ...
        filter_rear_right = np.logical_and((x_points >= self.fwd_range[0]), (x_points <= 0))
